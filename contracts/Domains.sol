...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) payable ERC721("Wave Music Name Service", "WAV") {
    tld = _tld;
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the Wave Music name service", "image": "data:image/svg+xml;base64,',
  ...
  function price(string calldata name) public pure returns (uint) {
    ...
    require(len > 0, "Name isn't long enough");
    //if (len == 3) {
